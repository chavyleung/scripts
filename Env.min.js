          ...
          case 'object':
            switch (this.getEnv()) {
              ...
              case 'Loon': {
                ...
                i && Object.assign(s, { openUrl: i })
                let o = t.mediaUrl || t['media-url']
                return o && Object.assign(s, { mediaUrl: o }), s
              }
              case 'Quantumult X': {
                const i = {}
                let o = t['open-url'] || t.url || t.openUrl || e
                o && Object.assign(i, { 'open-url': o })
                let r = t['media-url'] || t.mediaUrl
                r && Object.assign(i, { 'media-url': r })
                let a = t['update-pasteboard'] || t.updatePasteboard || s
                return a && Object.assign(i, { 'update-pasteboard': a }), i
              }
              case 'Node.js':
                return
            }
